...
class Block(pygame.sprite.Sprite):
    def __init__(self, color, width, height):
        ...
        self.rect.x = random.randint(0, 700 - width)
        self.rect.y = random.randint(0, 500 - height)
...
for _ in range(50):
    my_block = Block(RED,20,20)
    block_grp.add(my_block)
    all_sprites_grp.add(my_block)
